...
var _TtsSession = class _TtsSession2 {
  ...
  async init() {
    const { createPiperPhonemize } = await import("./piper-o91UDS6e-QXDZHHQP.js");
    __privateSet(this, _createPiperPhonemize, createPiperPhonemize);
    __privateSet(this, _ort, await import("./ort.bundle.min-HK56A3MQ.js"));
...
async function voices() {
  try {
    ...
    const LOCAL_VOICES_JSON = await import("./voices_static-D_OtJDHM-VM345FCB.js");
