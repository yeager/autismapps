...
export const ALL_APPS: AppDef[] = [
  ...
  { id: 'step-guide', name: 'app.step_guide', description: 'app.step_guide.desc', category: 'daily', icon: '/icons/step-guide.svg', route: '/apps/step-guide', ready: false },
  { id: 'clothes-chooser', name: 'app.clothes_chooser', description: 'app.clothes_chooser.desc', category: 'daily', icon: '/icons/clothes-chooser.svg', route: '/apps/clothes-chooser', ready: false },
  ...
  { id: 'practice-board', name: 'app.practice_board', description: 'app.practice_board.desc', category: 'time', icon: '/icons/practice-board.svg', route: '/apps/practice-board', ready: false },
  ...
  { id: 'diary', name: 'app.diary', description: 'app.diary.desc', category: 'play', icon: '/icons/diary.svg', route: '/apps/diary', ready: false },
  { id: 'chooser', name: 'app.chooser', description: 'app.chooser.desc', category: 'play', icon: '/icons/chooser.svg', route: '/apps/chooser', ready: false }
];
