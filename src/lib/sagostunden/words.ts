...
export const ALL_WORDS: Word[] = [
  ...
  { id: 'uggla', sv: 'uggla', en: 'owl', gender: 'en', category: 'djur', arasaac: 8010, plural: 'ugglor' },
  ...
  { id: 'skola', sv: 'skola', en: 'school', gender: 'en', category: 'platser', arasaac: 2974 },
  { id: 'park', sv: 'park', en: 'park', gender: 'en', category: 'platser', arasaac: 7698 },
  { id: 'stad', sv: 'stad', en: 'city', gender: 'en', category: 'platser', arasaac: 5379 },
  ...
  { id: 'lekplats', sv: 'lekplats', en: 'playground', gender: 'en', category: 'platser', arasaac: 35695 },
  ...
  { id: 'cirkus', sv: 'cirkus', en: 'circus', gender: 'en', category: 'platser', arasaac: 2811 },
  { id: 'zoo', sv: 'zoo', en: 'zoo', gender: 'ett', category: 'platser', arasaac: 6953 },

  // === SAKER (30) ===
  { id: 'boll', sv: 'boll', en: 'ball', gender: 'en', category: 'saker', arasaac: 4773 },
  ...
  { id: 'stjärna', sv: 'stjärna', en: 'star', gender: 'en', category: 'saker', arasaac: 5505 },
  ...
  { id: 'cykel', sv: 'cykel', en: 'bicycle', gender: 'en', category: 'saker', arasaac: 6932 },
  { id: 'bil', sv: 'bil', en: 'car', gender: 'en', category: 'saker', arasaac: 3389 },
  { id: 'tåg', sv: 'tåg', en: 'train', gender: 'ett', category: 'saker', arasaac: 2339 },
  { id: 'flygplan', sv: 'flygplan', en: 'airplane', gender: 'ett', category: 'saker', arasaac: 3378 },
  { id: 'raket', sv: 'raket', en: 'rocket', gender: 'en', category: 'saker', arasaac: 6924 },
  { id: 'ballong', sv: 'ballong', en: 'balloon', gender: 'en', category: 'saker', arasaac: 3442 },
  { id: 'present', sv: 'present', en: 'gift', gender: 'en', category: 'saker', arasaac: 2408 },
  ...
  { id: 'sol', sv: 'sol', en: 'sun', gender: 'en', category: 'saker', arasaac: 3057 },
  ...
  { id: 'hjärta', sv: 'hjärta', en: 'heart', gender: 'ett', category: 'saker', arasaac: 2986 },
  { id: 'diamant', sv: 'diamant', en: 'diamond', gender: 'en', category: 'saker', arasaac: 4980 },
  { id: 'gitarr', sv: 'gitarr', en: 'guitar', gender: 'en', category: 'saker', arasaac: 6475 },
  ...
  { id: 'choklad', sv: 'choklad', en: 'chocolate', gender: 'en', category: 'mat', arasaac: 34233 },
  ...
  { id: 'ost', sv: 'ost', en: 'cheese', gender: 'en', category: 'mat', arasaac: 2494 },
  ...
  { id: 'pirat', sv: 'pirat', en: 'pirate', gender: 'en', category: 'personer', arasaac: 6556 },
  { id: 'sjöjungfru', sv: 'sjöjungfru', en: 'mermaid', gender: 'en', category: 'personer', arasaac: 11346 },
  { id: 'drake', sv: 'drake', en: 'dragon', gender: 'en', category: 'personer', arasaac: 5589 },
  ...
  { id: 'tomte', sv: 'tomte', en: 'gnome', gender: 'en', category: 'personer', arasaac: 2854 },
  { id: 'älva', sv: 'älva', en: 'fairy', gender: 'en', category: 'personer', arasaac: 5029 },
  { id: 'jätte', sv: 'jätte', en: 'giant', gender: 'en', category: 'personer', arasaac: 5482 },
  ...
  { id: 'sjörövare', sv: 'sjörövare', en: 'buccaneer', gender: 'en', category: 'personer', arasaac: 6556 },
  { id: 'docka', sv: 'docka', en: 'doll', gender: 'en', category: 'personer', arasaac: 3545 },

  // === VERB (35) ===
  { id: 'springa', sv: 'springa', en: 'run', gender: 'en', category: 'verb', arasaac: 26238 },
  { id: 'hoppa', sv: 'hoppa', en: 'jump', gender: 'en', category: 'verb', arasaac: 6406 },
  { id: 'simma', sv: 'simma', en: 'swim', gender: 'en', category: 'verb', arasaac: 39052 },
  { id: 'flyga', sv: 'flyga', en: 'fly', gender: 'en', category: 'verb', arasaac: 6395 },
  { id: 'äta', sv: 'äta', en: 'eat', gender: 'en', category: 'verb', arasaac: 6246 },
  ...
  { id: 'leka', sv: 'leka', en: 'play', gender: 'en', category: 'verb', arasaac: 35747 },
  { id: 'rita', sv: 'rita', en: 'draw', gender: 'en', category: 'verb', arasaac: 6388 },
  { id: 'bygga', sv: 'bygga', en: 'build', gender: 'en', category: 'verb', arasaac: 8088 },
  { id: 'gömma', sv: 'gömma', en: 'hide', gender: 'en', category: 'verb', arasaac: 6402 },
  { id: 'hitta', sv: 'hitta', en: 'find', gender: 'en', category: 'verb', arasaac: 6493 },
  ...
  { id: 'gråta', sv: 'gråta', en: 'cry', gender: 'en', category: 'verb', arasaac: 13354 },
  { id: 'krama', sv: 'krama', en: 'hug', gender: 'en', category: 'verb', arasaac: 6404 },
  { id: 'viska', sv: 'viska', en: 'whisper', gender: 'en', category: 'verb', arasaac: 4550 },
  { id: 'ropa', sv: 'ropa', en: 'shout', gender: 'en', category: 'verb', arasaac: 6450 },
  { id: 'drömma', sv: 'drömma', en: 'dream', gender: 'en', category: 'verb', arasaac: 6552 },
  { id: 'tänka', sv: 'tänka', en: 'think', gender: 'en', category: 'verb', arasaac: 6464 },
  { id: 'hjälpa', sv: 'hjälpa', en: 'help', gender: 'en', category: 'verb', arasaac: 38796 },
  { id: 'dela', sv: 'dela', en: 'share', gender: 'en', category: 'verb', arasaac: 6384 },
  { id: 'laga', sv: 'laga', en: 'cook', gender: 'en', category: 'verb', arasaac: 38900 },
  { id: 'baka', sv: 'baka', en: 'bake', gender: 'en', category: 'verb', arasaac: 6366 },
  { id: 'måla', sv: 'måla', en: 'paint', gender: 'en', category: 'verb', arasaac: 5487 },
  { id: 'segla', sv: 'segla', en: 'sail', gender: 'en', category: 'verb', arasaac: 6444 },
  { id: 'åka', sv: 'åka', en: 'ride', gender: 'en', category: 'verb', arasaac: 7170 },
  ...
  { id: 'lyssna', sv: 'lyssna', en: 'listen', gender: 'en', category: 'verb', arasaac: 6564 },
  { id: 'fånga', sv: 'fånga', en: 'catch', gender: 'en', category: 'verb', arasaac: 6376 },
  { id: 'rädda', sv: 'rädda', en: 'rescue', gender: 'en', category: 'verb', arasaac: 8087 },
];
